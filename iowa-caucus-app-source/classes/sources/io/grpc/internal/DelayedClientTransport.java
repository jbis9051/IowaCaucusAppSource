...
final class DelayedClientTransport implements ManagedClientTransport {
    ...
    public final Runnable start(ManagedClientTransport.Listener listener2) {
        this.listener = listener2;
        this.reportTransportInUse = new 1(this, listener2);
        this.reportTransportNotInUse = new 2(this, listener2);
        this.reportTransportTerminated = new 3(this, listener2);
        return null;
    }
    ...
    public final ClientStream newStream(MethodDescriptor<?, ?> methodDescriptor, Metadata metadata, CallOptions callOptions) {
        ...
        try {
            ...
            LoadBalancer$SubchannelPicker loadBalancer$SubchannelPicker = null;
            long j = -1;
            while (true) {
                synchronized (this.lock) {
                    if (this.shutdownStatus == null) {
                        if (this.lastPicker != null) {
                            if (loadBalancer$SubchannelPicker != null && j == this.lastPickerVersion) {
                                failingClientStream = createPendingStream(pickSubchannelArgsImpl);
                                break;
                            }
                            loadBalancer$SubchannelPicker = this.lastPicker;
                            j = this.lastPickerVersion;
                            ClientTransport transportFromPickResult = GrpcUtil.getTransportFromPickResult(loadBalancer$SubchannelPicker.pickSubchannel(pickSubchannelArgsImpl), callOptions.isWaitForReady());
    ...
    private PendingStream createPendingStream(LoadBalancer.PickSubchannelArgs pickSubchannelArgs) {
        PendingStream pendingStream = new PendingStream(this, pickSubchannelArgs, (1) null);
    ...
    public final void shutdown(io.grpc.Status r4) {
        /*
            r3 = this;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0059, code lost:
        r5.execute(new io.grpc.internal.DelayedClientTransport.5(r7, r2, r3));
        r0.add(r2);
     */
