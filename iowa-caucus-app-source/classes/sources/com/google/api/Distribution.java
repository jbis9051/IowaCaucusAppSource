...
public final class Distribution extends GeneratedMessageLite<Distribution, Builder> implements DistributionOrBuilder {
    ...
    public static final class BucketOptions extends GeneratedMessageLite<BucketOptions, Builder> implements BucketOptionsOrBuilder {
        ...
        public static final class Linear extends GeneratedMessageLite<Linear, Builder> implements LinearOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Linear, Builder> implements LinearOrBuilder {
                ...
                public int getNumFiniteBuckets() {
                    return this.instance.getNumFiniteBuckets();
                }

                public Builder setNumFiniteBuckets(int i) {
                    copyOnWrite();
                    this.instance.setNumFiniteBuckets(i);
                    return this;
                }

                public Builder clearNumFiniteBuckets() {
                    copyOnWrite();
                    this.instance.clearNumFiniteBuckets();
                    return this;
                }
                ...
                public double getOffset() {
                    return this.instance.getOffset();
                }

                public Builder setOffset(double d) {
                    copyOnWrite();
                    this.instance.setOffset(d);
                    return this;
                }

                public Builder clearOffset() {
                    copyOnWrite();
                    this.instance.clearOffset();
                    return this;
                }
            }
        ...
        public static final class Exponential extends GeneratedMessageLite<Exponential, Builder> implements ExponentialOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Exponential, Builder> implements ExponentialOrBuilder {
                ...
                public double getGrowthFactor() {
                    return this.instance.getGrowthFactor();
                }

                public Builder setGrowthFactor(double d) {
                    copyOnWrite();
                    this.instance.setGrowthFactor(d);
                    return this;
                }

                public Builder clearGrowthFactor() {
                    copyOnWrite();
                    this.instance.clearGrowthFactor();
                    return this;
                }
                ...
                public Builder setScale(double d) {
                    copyOnWrite();
                    this.instance.setScale(d);
                    return this;
                }

                public Builder clearScale() {
                    copyOnWrite();
                    this.instance.clearScale();
                    return this;
                }
            }
        ...
        public static final class Explicit extends GeneratedMessageLite<Explicit, Builder> implements ExplicitOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Explicit, Builder> implements ExplicitOrBuilder {
                ...
                public List<Double> getBoundsList() {
                    return Collections.unmodifiableList(this.instance.getBoundsList());
                }

                public int getBoundsCount() {
                    return this.instance.getBoundsCount();
                }

                public double getBounds(int i) {
                    return this.instance.getBounds(i);
                }

                public Builder setBounds(int i, double d) {
                    copyOnWrite();
                    this.instance.setBounds(i, d);
                    return this;
                }

                public Builder addBounds(double d) {
                    copyOnWrite();
                    this.instance.addBounds(d);
                    return this;
                }

                public Builder addAllBounds(Iterable<? extends Double> iterable) {
                    copyOnWrite();
                    this.instance.addAllBounds(iterable);
                    return this;
                }

                public Builder clearBounds() {
                    copyOnWrite();
                    this.instance.clearBounds();
                    return this;
                }
            }
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<BucketOptions, Builder> implements BucketOptionsOrBuilder {
            ...
            public OptionsCase getOptionsCase() {
                return this.instance.getOptionsCase();
            }
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    if (i2 == 1) {
                        ...
                        this.options_ = mergeFromVisitor.visitOneofMessage(z, this.options_, bucketOptions.options_);
                    } else if (i2 == 2) {
                        if (this.optionsCase_ == 2) {
                            z = true;
                        }
                    ...
                    if (mergeFromVisitor == GeneratedMessageLite.MergeFromVisitor.INSTANCE && (i = bucketOptions.optionsCase_) != 0) {
                        this.optionsCase_ = i;
                    }
                    return this;
                case 6:
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Distribution, Builder> implements DistributionOrBuilder {
        ...
        public double getSumOfSquaredDeviation() {
            return this.instance.getSumOfSquaredDeviation();
        }

        public Builder setSumOfSquaredDeviation(double d) {
            copyOnWrite();
            this.instance.setSumOfSquaredDeviation(d);
            return this;
        }

        public Builder clearSumOfSquaredDeviation() {
            copyOnWrite();
            this.instance.clearSumOfSquaredDeviation();
            return this;
        }
        ...
        public Builder setRange(Range.Builder builder) {
            copyOnWrite();
            this.instance.setRange(builder);
            return this;
        }

        public Builder mergeRange(Range range) {
            copyOnWrite();
            this.instance.mergeRange(range);
            return this;
        }

        public Builder clearRange() {
            copyOnWrite();
            this.instance.clearRange();
            return this;
        }

        public boolean hasBucketOptions() {
            return this.instance.hasBucketOptions();
        }

        public BucketOptions getBucketOptions() {
            return this.instance.getBucketOptions();
        }

        public Builder setBucketOptions(BucketOptions bucketOptions) {
            copyOnWrite();
            this.instance.setBucketOptions(bucketOptions);
            return this;
        }

        public Builder setBucketOptions(BucketOptions.Builder builder) {
            copyOnWrite();
            this.instance.setBucketOptions(builder);
            return this;
        }

        public Builder mergeBucketOptions(BucketOptions bucketOptions) {
            copyOnWrite();
            this.instance.mergeBucketOptions(bucketOptions);
            return this;
        }

        public Builder clearBucketOptions() {
            copyOnWrite();
            this.instance.clearBucketOptions();
            return this;
        }

        public List<Long> getBucketCountsList() {
            return Collections.unmodifiableList(this.instance.getBucketCountsList());
        }

        public int getBucketCountsCount() {
            return this.instance.getBucketCountsCount();
        }

        public long getBucketCounts(int i) {
            return this.instance.getBucketCounts(i);
        }

        public Builder setBucketCounts(int i, long j) {
            copyOnWrite();
            this.instance.setBucketCounts(i, j);
            return this;
        }

        public Builder addBucketCounts(long j) {
            copyOnWrite();
            this.instance.addBucketCounts(j);
            return this;
        }

        public Builder addAllBucketCounts(Iterable<? extends Long> iterable) {
            copyOnWrite();
            this.instance.addAllBucketCounts(iterable);
            return this;
        }

        public Builder clearBucketCounts() {
            copyOnWrite();
            this.instance.clearBucketCounts();
            return this;
        }
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 5:
                ...
                this.count_ = mergeFromVisitor.visitLong(this.count_ != 0, this.count_, distribution.count_ != 0, distribution.count_);
                this.mean_ = mergeFromVisitor.visitDouble(this.mean_ != 0.0d, this.mean_, distribution.mean_ != 0.0d, distribution.mean_);
                this.sumOfSquaredDeviation_ = mergeFromVisitor.visitDouble(this.sumOfSquaredDeviation_ != 0.0d, this.sumOfSquaredDeviation_, distribution.sumOfSquaredDeviation_ != 0.0d, distribution.sumOfSquaredDeviation_);
                this.range_ = mergeFromVisitor.visitMessage(this.range_, distribution.range_);
                this.bucketOptions_ = mergeFromVisitor.visitMessage(this.bucketOptions_, distribution.bucketOptions_);
                this.bucketCounts_ = mergeFromVisitor.visitLongList(this.bucketCounts_, distribution.bucketCounts_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 8) {
                                ...
                                this.bucketOptions_ = codedInputStream.readMessage(BucketOptions.parser(), extensionRegistryLite);
                                if (builder2 != null) {
