...
public final class Experimental extends GeneratedMessageLite<Experimental, Builder> implements ExperimentalOrBuilder {
    ...
    public void mergeAuthorization(AuthorizationConfig authorizationConfig) {
        ...
        if (authorizationConfig2 == null || authorizationConfig2 == AuthorizationConfig.getDefaultInstance()) {
            ...
            this.authorization_ = AuthorizationConfig.newBuilder(this.authorization_).mergeFrom(authorizationConfig).buildPartial();
        }
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Experimental, Builder> implements ExperimentalOrBuilder {
        ...
        public boolean hasAuthorization() {
            return this.instance.hasAuthorization();
        }

        public AuthorizationConfig getAuthorization() {
            return this.instance.getAuthorization();
        }

        public Builder setAuthorization(AuthorizationConfig authorizationConfig) {
            copyOnWrite();
            this.instance.setAuthorization(authorizationConfig);
            return this;
        }

        public Builder setAuthorization(AuthorizationConfig.Builder builder) {
            copyOnWrite();
            this.instance.setAuthorization(builder);
            return this;
        }

        public Builder mergeAuthorization(AuthorizationConfig authorizationConfig) {
            copyOnWrite();
            this.instance.mergeAuthorization(authorizationConfig);
            return this;
        }

        public Builder clearAuthorization() {
            copyOnWrite();
            this.instance.clearAuthorization();
            return this;
        }
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 5:
                this.authorization_ = ((GeneratedMessageLite.Visitor) obj).visitMessage(this.authorization_, ((Experimental) obj2).authorization_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 66) {
                                ...
                                this.authorization_ = codedInputStream.readMessage(AuthorizationConfig.parser(), extensionRegistryLite);
                                if (builder != null) {
