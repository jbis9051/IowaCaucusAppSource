...
public class zzjp implements zzgl {
    ...
    private static void zza(zzbr.zzg.zza zza2) {
        zza2.zzb((long) com.facebook.common.time.Clock.MAX_TIME).zzc(Long.MIN_VALUE);
    ...
    private final void zza(zzf zzf2) {
        ...
        if (!TextUtils.isEmpty(zzf2.zzd()) || !TextUtils.isEmpty(zzf2.zze())) {
            ...
            encodedAuthority.path(valueOf.length() != 0 ? "config/app/".concat(valueOf) : new String("config/app/")).appendQueryParameter("app_instance_id", zzf2.zzc()).appendQueryParameter("platform", "android").appendQueryParameter("gmp_version", String.valueOf(zzb2.zzf()));
            ...
            try {
                ...
                if (zza2 != null && !TextUtils.isEmpty(zzb3)) {
                    ...
                    arrayMap.put("If-Modified-Since", zzb3);
                }
                this.zzr = true;
                zzen zzd3 = zzd();
