...
public abstract class RandomAccessReader {
    ...
    public float getS15Fixed16(int i) throws IOException {
        ...
        validateIndex(i, 4);
        if (this._isMotorolaByteOrder) {
            byte b = (getByte(i + 3) & 255) | ((getByte(i + 2) & 255) << 8);
            d = (double) ((float) (((getByte(i) & 255) << 8) | (getByte(i + 1) & 255)));
            double d3 = (double) b;
            Double.isNaN(d3);
            d2 = d3 / 65536.0d;
            Double.isNaN(d);
        } else {
            byte b2 = (getByte(i) & 255) | ((getByte(i + 1) & 255) << 8);
            d = (double) ((float) (((getByte(i + 3) & 255) << 8) | (getByte(i + 2) & 255)));
            double d4 = (double) b2;
            Double.isNaN(d4);
            d2 = d4 / 65536.0d;
            Double.isNaN(d);
