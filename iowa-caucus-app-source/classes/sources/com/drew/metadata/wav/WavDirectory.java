...
public class WavDirectory extends Directory {
    ...
    static {
        ...
        _audioEncodingMap.put(Integer.valueOf(HttpUrlConnectionNetworkFetcher.HTTP_PERMANENT_REDIRECT), "Sipro Lab G.729A");
        ...
        _audioEncodingMap.put(Integer.valueOf(StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB), "Digital Theater Systems DTS DS");
