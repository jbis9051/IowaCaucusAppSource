...
public abstract class RenderableView extends VirtualView {
    ...
    public void renderMarkers(Canvas canvas, Paint paint, float f) {
        MarkerView definedMarker = getSvgView().getDefinedMarker(this.mMarkerStart);
        MarkerView markerView = (MarkerView) getSvgView().getDefinedMarker(this.mMarkerMid);
        MarkerView markerView2 = (MarkerView) getSvgView().getDefinedMarker(this.mMarkerEnd);
        if (this.elements == null) {
            return;
        }
        if (definedMarker != null || markerView != null || markerView2 != null) {
            contextElement = this;
            ...
            while (it.hasNext()) {
                ...
                int i = 1.$SwitchMap$com$horcrux$svg$RNSVGMarkerType[rNSVGMarkerPosition.type.ordinal()];
                MarkerView markerView3 = i != 1 ? i != 2 ? i != 3 ? null : markerView2 : markerView : definedMarker;
                if (markerView3 != null) {
                    markerView3.renderMarker(canvas, paint, f, rNSVGMarkerPosition, relativeOnOther);
                    this.mMarkerPath.addPath(markerView3.getPath(canvas, paint), markerView3.markerTransform);
                }
            }
            contextElement = null;
        }
