    ...
    public static final class Builder {
        ...
        public Builder maxAge(int i, TimeUnit timeUnit) {
            if (i >= 0) {
                ...
                this.maxAgeSeconds = seconds > 2147483647L ? RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO : (int) seconds;
                return this;
            }
        ...
        public Builder maxStale(int i, TimeUnit timeUnit) {
            if (i >= 0) {
                long seconds = timeUnit.toSeconds((long) i);
                this.maxStaleSeconds = seconds > 2147483647L ? RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO : (int) seconds;
                return this;
            }
        ...
        public Builder minFresh(int i, TimeUnit timeUnit) {
            if (i >= 0) {
                long seconds = timeUnit.toSeconds((long) i);
                this.minFreshSeconds = seconds > 2147483647L ? RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO : (int) seconds;
                return this;
            }
