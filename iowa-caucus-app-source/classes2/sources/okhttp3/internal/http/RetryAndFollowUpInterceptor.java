...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private Request followUpRequest(Response response, Route route) throws IOException {
        ...
        if (response != null) {
            ...
            if (code == 307 || code == 308) {
                ...
                } else if ((response.priorResponse() == null || response.priorResponse().code() != 503) && retryAfter(response, RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO) == 0) {
                    return response.request();
                } else {
                    return null;
                }
    ...
    private int retryAfter(Response response, int i) {
        ...
        return header.matches("\\d+") ? Integer.valueOf(header).intValue() : RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO;
    }
