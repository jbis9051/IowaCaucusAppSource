...
public class NodesManager implements EventDispatcherListener {
    ...
    public NodesManager(ReactContext reactContext) {
        ...
        this.mUIManager = reactContext.getNativeModule(UIManagerModule.class);
        ...
        this.mEventEmitter = reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class);
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [com.swmansion.reanimated.NodesManager$2, java.lang.Runnable] */
    /* access modifiers changed from: private */
    ...
    public void getValue(int i, Callback callback) {
        callback.invoke(new Object[]{this.mAnimatedNodes.get(i).value()});
    }
