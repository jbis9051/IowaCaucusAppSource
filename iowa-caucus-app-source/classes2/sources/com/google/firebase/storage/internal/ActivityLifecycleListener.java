...
public class ActivityLifecycleListener {
    ...
    private static class OnStopCallback extends LifecycleCallback {
        ...
        public static OnStopCallback getInstance(Activity activity) {
            ...
            OnStopCallback callbackOrNull = fragment.getCallbackOrNull(TAG, OnStopCallback.class);
            return callbackOrNull == null ? new OnStopCallback(fragment) : callbackOrNull;
        }
