...
public final class zzas {
    ...
    private static final zzaz<String> zzb = zzaz.zza("firebaseAppName", "firebaseUserUid", "operation", "tenantId", "verifyAssertionRequest", "statusCode", "statusMessage", JsonMarshaller.TIMESTAMP);
    ...
    public static void zza(Context context, zzfr zzfr, String str, @Nullable String str2) {
        ...
        edit.putLong(JsonMarshaller.TIMESTAMP, DefaultClock.getInstance().currentTimeMillis());
        edit.commit();
    }
