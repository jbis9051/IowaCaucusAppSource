...
public class FederatedSignInActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle bundle) {
        FederatedSignInActivity.super.onCreate(bundle);
    ...
    public void onSaveInstanceState(Bundle bundle) {
        FederatedSignInActivity.super.onSaveInstanceState(bundle);
        bundle.putBoolean("com.google.firebase.auth.internal.KEY_STARTED_SIGN_IN", this.zzb);
    }

    /* JADX WARNING: type inference failed for: r10v0, types: [android.content.Context, com.google.firebase.auth.internal.FederatedSignInActivity, androidx.fragment.app.FragmentActivity] */
    /* access modifiers changed from: protected */
    ...
    public void onResume() {
        ...
        L_0x005b:
            android.os.Parcelable$Creator r7 = com.google.android.gms.internal.firebase_auth.zzfr.CREATOR
    ...
    public void onNewIntent(Intent intent) {
        Runnable runnable;
        FederatedSignInActivity.super.onNewIntent(intent);
        Handler handler = zzd;
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [android.content.Context, com.google.firebase.auth.internal.FederatedSignInActivity] */
    /* access modifiers changed from: private */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.google.firebase.auth.internal.FederatedSignInActivity] */
