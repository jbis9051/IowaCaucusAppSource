    ...
    static int lookAheadTest(CharSequence charSequence, int i, int i2) {
        ...
        while (true) {
            ...
            if (i5 == charSequence.length()) {
                ...
                int[] iArr = new int[6];
                int findMinimums = findMinimums(fArr, iArr, RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, bArr);
            ...
            if (i4 >= 4) {
                ...
                findMinimums(fArr, iArr2, RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, bArr2);
