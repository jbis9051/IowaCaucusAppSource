...
class FontData {
    ...
    static class AbsoluteFontWeight {
        ...
        private static final int[] absoluteFontWeights = {400, LogSeverity.ALERT_VALUE, 100, LogSeverity.INFO_VALUE, LogSeverity.NOTICE_VALUE, 400, LogSeverity.ERROR_VALUE, LogSeverity.CRITICAL_VALUE, LogSeverity.ALERT_VALUE, LogSeverity.EMERGENCY_VALUE, 900};
    ...
    private FontData() {
        ...
        this.absoluteFontWeight = LogSeverity.WARNING_VALUE;
    ...
    FontData(ReadableMap readableMap, FontData fontData2, double d) {
        ...
        this.letterSpacing = readableMap.hasKey(LETTER_SPACING) ? toAbsolute(readableMap, LETTER_SPACING, d, this.fontSize, 0.0d) : fontData2.letterSpacing;
    }
}
