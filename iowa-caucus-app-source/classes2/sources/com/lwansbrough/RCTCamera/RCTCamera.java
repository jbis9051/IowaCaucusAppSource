...
public class RCTCamera {
        ...
        if (acquireCameraInstance != null) {
            ...
            switch (c) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    size = getBestSize(parameters.getSupportedPictureSizes(), RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO);
                    break;
                case 3:
                    Camera.Size bestSize = getBestSize(parameters.getSupportedPreviewSizes(), RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO);
    ...
    public CamcorderProfile setCaptureVideoQuality(int i, String str) {
        ...
        if (c == 0) {
            ...
            size = getBestSize(supportedVideoSizes, RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO);
