...
public class AsyncLocalStorageUtil {
    ...
    public static String getItemImpl(SQLiteDatabase sQLiteDatabase, String str) {
        Cursor query = sQLiteDatabase.query("catalystLocalStorage", new String[]{FirebaseAnalytics.Param.VALUE}, "key=?", new String[]{str}, (String) null, (String) null, (String) null);
        try {
