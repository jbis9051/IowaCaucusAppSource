...
public final class AsyncStorageModule extends ReactContextBaseJavaModule implements ModuleDataCleaner.Cleanable {
    ...
    public void initialize() {
        AsyncStorageModule.super.initialize();
        this.mShuttingDown = false;
    }
    ...
    public void multiGet(final ReadableArray readableArray, final Callback callback) {
        if (readableArray == null) {
            callback.invoke(new Object[]{AsyncStorageErrorUtil.getInvalidKeyError((String) null), null});
            return;
        }
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                if (!AsyncStorageModule.this.ensureDatabase()) {
                    callback.invoke(new Object[]{AsyncStorageErrorUtil.getDBError((String) null), null});
                    return;
                }
                String[] strArr = {"key", FirebaseAnalytics.Param.VALUE};
                ...
                while (i < readableArray.size()) {
                    ...
                    try {
                        ...
                        callback.invoke(new Object[]{AsyncStorageErrorUtil.getError((String) null, e.getMessage()), null});
                        query.close();
                        return;
                    } catch (Throwable th) {
                        query.close();
        ...
        if (readableArray.size() == 0) {
            ...
            new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
                ...
                public void doInBackgroundGuarded(Void... voidArr) {
                    ...
                    if (!AsyncStorageModule.this.ensureDatabase()) {
                        callback.invoke(new Object[]{AsyncStorageErrorUtil.getDBError((String) null)});
                        return;
                    }
        ...
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    FLog.w("ReactNative", e.getMessage(), e);
                    callback.invoke(new Object[]{AsyncStorageErrorUtil.getError((String) null, e.getMessage())});
                }
            }
        }.executeOnExecutor(this.executor, new Void[0]);
    }
