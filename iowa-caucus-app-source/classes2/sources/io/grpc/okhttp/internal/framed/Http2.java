...
public final class Http2 implements Variant {
    ...
    public FrameReader newReader(BufferedSource bufferedSource, boolean z) {
        return new Reader(bufferedSource, CodedOutputStream.DEFAULT_BUFFER_SIZE, z);
    }
    ...
    static final class Reader implements FrameReader {
        ...
        private void readPriority(FrameReader.Handler handler, int i) throws IOException {
            ...
            handler.priority(i, readInt & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, (this.source.readByte() & UnsignedBytes.MAX_VALUE) + 1, (Integer.MIN_VALUE & readInt) != 0);
        }
        ...
        private void readPushPromise(FrameReader.Handler handler, int i, byte b, int i2) throws IOException {
            ...
            if (i2 != 0) {
                ...
                handler.pushPromise(i2, this.source.readInt() & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, readHeaderBlock(Http2.lengthWithoutPadding(i - 4, b, s), s, b, i2));
                return;
            }
    ...
    static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            this.streamId = this.source.readInt() & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO;
            if (readByte != 9) {
    ...
    static final class FrameLogger {
        private static final String[] BINARY = new String[CipherStorageKeystoreAESCBC.ENCRYPTION_KEY_SIZE];
