...
final class RoundRobinLoadBalancer extends LoadBalancer {
    ...
    public void handleResolvedAddresses(LoadBalancer.ResolvedAddresses resolvedAddresses) {
        ...
        for (T t : set) {
            ...
            T t2 = (LoadBalancer.Subchannel) Preconditions.checkNotNull(this.helper.createSubchannel(t, builder.build()), "subchannel");
            if (ref != null) {
                ref.value = t2;
            }
    ...
    public void handleNameResolutionError(Status status) {
        ...
        EmptyPicker emptyPicker = this.currentPicker;
