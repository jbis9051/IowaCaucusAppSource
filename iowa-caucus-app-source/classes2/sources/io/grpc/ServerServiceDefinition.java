...
public final class ServerServiceDefinition {
    ...
    public static final class Builder {
        ...
        public ServerServiceDefinition build() {
            ...
            Iterator<MethodDescriptor<?, ?>> it = serviceDescriptor2.getMethods().iterator();
            while (it.hasNext()) {
                ...
                if (serverMethodDefinition == null) {
                    throw new IllegalStateException("No method bound for descriptor entry " + methodDescriptor2.getFullMethodName());
                } else if (serverMethodDefinition.getMethodDescriptor() != methodDescriptor2) {
                    throw new IllegalStateException("Bound method for " + methodDescriptor2.getFullMethodName() + " not same instance as method in service descriptor");
                }
            }
            if (hashMap.size() <= 0) {
