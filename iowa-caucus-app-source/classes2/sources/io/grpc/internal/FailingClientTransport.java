...
class FailingClientTransport implements ClientTransport {
    ...
    public void ping(final ClientTransport$PingCallback clientTransport$PingCallback, Executor executor) {
        executor.execute(new Runnable() {
            public void run() {
                clientTransport$PingCallback.onFailure(FailingClientTransport.this.error.asException());
            }
        });
    }
