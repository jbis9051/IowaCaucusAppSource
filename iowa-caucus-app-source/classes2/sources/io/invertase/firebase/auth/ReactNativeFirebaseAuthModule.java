...
class ReactNativeFirebaseAuthModule extends ReactNativeFirebaseModule {
    ...
    public void initialize() {
        ReactNativeFirebaseAuthModule.super.initialize();
        Log.d(TAG, "instance-initialized");
    }

    public void onCatalystInstanceDestroy() {
        ReactNativeFirebaseAuthModule.super.onCatalystInstanceDestroy();
    ...
    public void sendPasswordResetEmail(String str, String str2, ReadableMap readableMap, Promise promise) {
        ...
        if (readableMap == null) {
            instance.sendPasswordResetEmail(str2).addOnCompleteListener(getExecutor(), r0);
        } else {
            instance.sendPasswordResetEmail(str2, buildActionCodeSettings(readableMap)).addOnCompleteListener(getExecutor(), r0);
        }
    }
    ...
    public void sendSignInLinkToEmail(String str, String str2, ReadableMap readableMap, Promise promise) {
        ...
        FirebaseAuth instance = FirebaseAuth.getInstance(FirebaseApp.getInstance(str));
        instance.sendSignInLinkToEmail(str2, buildActionCodeSettings(readableMap)).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$1;
    ...
    public void delete(String str, Promise promise) {
        ...
        Log.d(TAG, "delete");
        if (currentUser != null) {
            currentUser.delete().addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
                private final /* synthetic */ Promise f$1;
    ...
    public void reload(String str, Promise promise) {
        ...
        currentUser.reload().addOnCompleteListener(getExecutor(), new OnCompleteListener(instance, promise) {
    ...
    public void sendEmailVerification(String str, ReadableMap readableMap, Promise promise) {
        ...
        if (readableMap == null) {
            currentUser.sendEmailVerification().addOnCompleteListener(getExecutor(), r1);
        } else {
            currentUser.sendEmailVerification(buildActionCodeSettings(readableMap)).addOnCompleteListener(getExecutor(), r1);
        }
    }
    ...
    public void updateEmail(String str, String str2, Promise promise) {
        ...
        currentUser.updateEmail(str2).addOnCompleteListener(getExecutor(), new OnCompleteListener(instance, promise) {
            private final /* synthetic */ FirebaseAuth f$1;
            private final /* synthetic */ Promise f$2;
    ...
    public void updatePassword(String str, String str2, Promise promise) {
        ...
        currentUser.updatePassword(str2).addOnCompleteListener(getExecutor(), new OnCompleteListener(instance, promise) {
            private final /* synthetic */ FirebaseAuth f$1;
            private final /* synthetic */ Promise f$2;
    ...
    private void updatePhoneNumber(String str, String str2, String str3, String str4, Promise promise) {
        ...
        if (phoneAuthCredential == null) {
            ...
            currentUser.updatePhoneNumber(phoneAuthCredential).addOnCompleteListener(getExecutor(), new OnCompleteListener(instance, promise) {
                private final /* synthetic */ FirebaseAuth f$1;
                private final /* synthetic */ Promise f$2;
    ...
    public void updateProfile(String str, ReadableMap readableMap, Promise promise) {
        ...
        currentUser.updateProfile(builder.build()).addOnCompleteListener(getExecutor(), new OnCompleteListener(instance, promise) {
            private final /* synthetic */ FirebaseAuth f$1;
            private final /* synthetic */ Promise f$2;
    ...
    private void signInWithCredential(String str, String str2, String str3, String str4, Promise promise) {
        ...
        instance.signInWithCredential(credentialForProvider).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$1;
    ...
    public void signInWithPhoneNumber(String str, String str2, boolean z, final Promise promise) {
        ...
        AnonymousClass1 r6 = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                instance.signInWithCredential(phoneAuthCredential).addOnCompleteListener(ReactNativeFirebaseAuthModule.this.getExecutor(), new OnCompleteListener(phoneAuthCredential, promise) {
    ...
    public void confirmationResultConfirm(String str, String str2, Promise promise) {
        FirebaseAuth.getInstance(FirebaseApp.getInstance(str)).signInWithCredential(PhoneAuthProvider.getCredential(this.mVerificationId, str2)).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$1;
    ...
    public void confirmPasswordReset(String str, String str2, String str3, Promise promise) {
        ...
        FirebaseAuth.getInstance(FirebaseApp.getInstance(str)).confirmPasswordReset(str2, str3).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$1;
    ...
    public void applyActionCode(String str, String str2, Promise promise) {
        ...
        FirebaseAuth instance = FirebaseAuth.getInstance(FirebaseApp.getInstance(str));
        instance.applyActionCode(str2).addOnCompleteListener(getExecutor(), new OnCompleteListener(instance, promise) {
            private final /* synthetic */ FirebaseAuth f$1;
            private final /* synthetic */ Promise f$2;
    ...
    public void checkActionCode(String str, String str2, Promise promise) {
        ...
        FirebaseAuth.getInstance(FirebaseApp.getInstance(str)).checkActionCode(str2).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$1;
    ...
    private void linkWithCredential(String str, String str2, String str3, String str4, Promise promise) {
        ...
        Log.d(TAG, "link");
        if (currentUser != null) {
            currentUser.linkWithCredential(credentialForProvider).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
                private final /* synthetic */ Promise f$1;
    ...
    public void unlink(String str, String str2, Promise promise) {
        ...
        Log.d(TAG, "unlink");
        if (currentUser != null) {
            currentUser.unlink(str2).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
                private final /* synthetic */ Promise f$1;
    ...
    private void reauthenticateWithCredential(String str, String str2, String str3, String str4, Promise promise) {
        ...
        if (currentUser != null) {
            currentUser.reauthenticateAndRetrieveData(credentialForProvider).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
                private final /* synthetic */ Promise f$1;
    ...
    public void getIdToken(String str, Boolean bool, Promise promise) {
        ...
        if (currentUser == null) {
            ...
            currentUser.getIdToken(bool.booleanValue()).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
                private final /* synthetic */ Promise f$1;
    ...
    public void fetchSignInMethodsForEmail(String str, String str2, Promise promise) {
        ...
        instance.fetchSignInMethodsForEmail(str2).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$1;
    ...
    public void verifyPasswordResetCode(String str, String str2, Promise promise) {
        ...
        FirebaseAuth.getInstance(FirebaseApp.getInstance(str)).verifyPasswordResetCode(str2).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$1;
    ...
    private void promiseWithAuthResult(AuthResult authResult, Promise promise) {
        ...
        if (authResult.getAdditionalUserInfo() != null) {
            ...
            if (authResult.getAdditionalUserInfo().getProfile() != null) {
                SharedUtils.mapPutValue("profile", authResult.getAdditionalUserInfo().getProfile(), createMap2);
            }
