...
public class ReactNativeFirebaseFirestoreModule extends ReactNativeFirebaseModule {
    ...
    public void disableNetwork(String str, Promise promise) {
        this.module.disableNetwork(str).addOnCompleteListener(new OnCompleteListener(promise) {
            ...
            public final void onComplete(Task task) {
                ReactNativeFirebaseFirestoreModule.lambda$disableNetwork$0(this.f$0, task);
            }
        });
    }
    ...
    public void enableNetwork(String str, Promise promise) {
        this.module.enableNetwork(str).addOnCompleteListener(new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$0;
            ...
            public final void onComplete(Task task) {
                ReactNativeFirebaseFirestoreModule.lambda$enableNetwork$1(this.f$0, task);
            }
        });
    }
    ...
    public void settings(String str, ReadableMap readableMap, Promise promise) {
        this.module.settings(str, RCTConvertFirebase.toHashMap(readableMap)).addOnCompleteListener(new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$0;
            ...
            public final void onComplete(Task task) {
                ReactNativeFirebaseFirestoreModule.lambda$settings$2(this.f$0, task);
            }
        });
    }
