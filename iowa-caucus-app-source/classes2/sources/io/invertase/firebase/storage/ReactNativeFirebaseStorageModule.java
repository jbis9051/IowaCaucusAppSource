...
public class ReactNativeFirebaseStorageModule extends ReactNativeFirebaseModule {
    ...
    public void delete(String str, String str2, Promise promise) {
        getReferenceFromUrl(str2, str).delete().addOnCompleteListener(new OnCompleteListener(promise) {
    ...
    public void getDownloadURL(String str, String str2, Promise promise) {
        getReferenceFromUrl(str2, str).getDownloadUrl().addOnCompleteListener(new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$0;
    ...
    public void getMetadata(String str, String str2, Promise promise) {
        getReferenceFromUrl(str2, str).getMetadata().addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$0;
    ...
    public void list(String str, String str2, ReadableMap readableMap, Promise promise) {
        ...
        task.addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$0;
    ...
    public void listAll(String str, String str2, Promise promise) {
        getReferenceFromUrl(str2, str).listAll().addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$0;
    ...
    public void updateMetadata(String str, String str2, ReadableMap readableMap, Promise promise) {
        getReferenceFromUrl(str2, str).updateMetadata(ReactNativeFirebaseStorageCommon.buildMetadataFromMap(readableMap, (Uri) null)).addOnCompleteListener(getExecutor(), new OnCompleteListener(promise) {
            private final /* synthetic */ Promise f$0;
