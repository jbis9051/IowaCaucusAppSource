...
final class Http2Reader implements Closeable {
    ...
    final Hpack.Reader hpackReader = new Hpack.Reader(CodedOutputStream.DEFAULT_BUFFER_SIZE, this.continuation);
    ...
    private void readPushPromise(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        if (i2 != 0) {
            ...
            handler.pushPromise(i2, this.source.readInt() & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, readHeaderBlock(lengthWithoutPadding(i - 4, b, s), s, b, i2));
            return;
        }
