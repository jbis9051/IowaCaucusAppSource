...
public class BarcodeFormatUtils {
    ...
    static {
        ...
        sparseArray.put(CipherStorageKeystoreAESCBC.ENCRYPTION_KEY_SIZE, "QR_CODE");
        sparseArray.put(512, "UPC_A");
        sparseArray.put(1024, "UPC_E");
        sparseArray.put(HttpInterfaceBinding.MAX_BODY_LENGTH, "PDF417");
        sparseArray.put(CodedOutputStream.DEFAULT_BUFFER_SIZE, "AZTEC");
