...
public class ReactNativeFirebaseFirestoreDocumentModule extends ReactNativeFirebaseModule {
    ...
    public void onCatalystInstanceDestroy() {
        ReactNativeFirebaseFirestoreDocumentModule.super.onCatalystInstanceDestroy();
    ...
    public void documentGet(String str, String str2, ReadableMap readableMap, Promise promise) {
        ...
        }).addOnCompleteListener(new OnCompleteListener(promise) {
    ...
    public void documentSet(String str, String str2, ReadableMap readableMap, ReadableMap readableMap2, Promise promise) {
        ...
        }).continueWithTask(getExecutor(), new Continuation(readableMap2, UniversalFirebaseFirestoreCommon.getDocumentForFirestore(firestoreForApp, str2)) {
            private final /* synthetic */ ReadableMap f$0;
