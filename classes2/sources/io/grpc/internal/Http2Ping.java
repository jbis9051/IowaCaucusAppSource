...
public class Http2Ping {
    ...
    public static void notifyFailed(ClientTransport$PingCallback clientTransport$PingCallback, Executor executor, Throwable th) {
        doExecute(executor, asRunnable(clientTransport$PingCallback, th));
    }
    ...
    private static Runnable asRunnable(final ClientTransport$PingCallback clientTransport$PingCallback, final long j) {
        return new Runnable() {
            public void run() {
    ...
    private static Runnable asRunnable(final ClientTransport$PingCallback clientTransport$PingCallback, final Throwable th) {
        return new Runnable() {
            public void run() {
