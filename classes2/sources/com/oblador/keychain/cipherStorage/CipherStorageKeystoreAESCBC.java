...
public class CipherStorageKeystoreAESCBC implements CipherStorage {
    ...
    private KeyGenParameterSpec.Builder getKeyGenSpecBuilder(String str) {
        return new KeyGenParameterSpec.Builder(str, 3).setBlockModes(new String[]{ENCRYPTION_BLOCK_MODE}).setEncryptionPaddings(new String[]{ENCRYPTION_PADDING}).setRandomizedEncryptionRequired(true).setKeySize(ENCRYPTION_KEY_SIZE);
    }
}
