...
public class RNGestureHandlerRootHelper {
    ...
    public RNGestureHandlerRootHelper(ReactContext reactContext, ViewGroup viewGroup) {
        ...
        if (id >= 1) {
            ...
            Log.i("ReactNative", "[GESTURE HANDLER] Initialize gesture handler for root view " + this.mReactRootView);
    ...
    public void tearDown() {
        Log.i("ReactNative", "[GESTURE HANDLER] Tearing down gesture handler registered for root view " + this.mReactRootView);
