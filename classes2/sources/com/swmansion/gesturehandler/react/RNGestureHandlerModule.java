...
public class RNGestureHandlerModule extends ReactContextBaseJavaModule {
    ...
    public void onCatalystInstanceDestroy() {
        ...
        synchronized (this.mRoots) {
            while (!this.mRoots.isEmpty()) {
                ...
                RNGestureHandlerEnabledRootView rootView = rNGestureHandlerRootHelper.getRootView();
        ...
        RNGestureHandlerModule.super.onCatalystInstanceDestroy();
    }
    ...
    public static void handleHitSlopProperty(GestureHandler gestureHandler, ReadableMap readableMap) {
        ...
        if (map.hasKey(KEY_HIT_SLOP_TOP)) {
            f3 = PixelUtil.toPixelFromDIP(map.getDouble(KEY_HIT_SLOP_TOP));
        }
        float f6 = f3;
        ...
        if (map.hasKey(KEY_HIT_SLOP_BOTTOM)) {
            f4 = PixelUtil.toPixelFromDIP(map.getDouble(KEY_HIT_SLOP_BOTTOM));
        }
        gestureHandler.setHitSlop(f5, f6, f7, f4, map.hasKey(KEY_HIT_SLOP_WIDTH) ? PixelUtil.toPixelFromDIP(map.getDouble(KEY_HIT_SLOP_WIDTH)) : Float.NaN, map.hasKey(KEY_HIT_SLOP_HEIGHT) ? PixelUtil.toPixelFromDIP(map.getDouble(KEY_HIT_SLOP_HEIGHT)) : Float.NaN);
    }
}
