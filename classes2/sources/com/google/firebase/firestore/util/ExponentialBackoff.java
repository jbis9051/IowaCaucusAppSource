...
public class ExponentialBackoff {
    ...
    public ExponentialBackoff(AsyncQueue asyncQueue, AsyncQueue$TimerId asyncQueue$TimerId, long j, double d, long j2) {
    ...
    public void cancel() {
        AsyncQueue$DelayedTask asyncQueue$DelayedTask = this.timerTask;
