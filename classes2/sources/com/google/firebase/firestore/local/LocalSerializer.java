...
public final class LocalSerializer {
    ...
    private com.google.firebase.firestore.model.Document decodeDocument(com.google.firestore.v1.Document document, boolean z) {
        ...
        if (z) {
            document$DocumentState = Document$DocumentState.COMMITTED_MUTATIONS;
        } else {
            document$DocumentState = Document$DocumentState.SYNCED;
        }
        Document$DocumentState document$DocumentState2 = document$DocumentState;
        RemoteSerializer remoteSerializer = this.rpcSerializer;
        remoteSerializer.getClass();
        return new com.google.firebase.firestore.model.Document(decodeKey, decodeVersion, document$DocumentState2, document, LocalSerializer$$Lambda$1.lambdaFactory$(remoteSerializer));
    }
