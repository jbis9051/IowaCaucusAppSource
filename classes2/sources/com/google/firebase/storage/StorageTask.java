...
public abstract class StorageTask<ResultT extends ProvideError> extends ControllableTask<ResultT> {
    ...
    @VisibleForTesting
    final TaskListenerImpl<OnCanceledListener, ResultT> cancelManager = new TaskListenerImpl<>(this, CipherStorageKeystoreAESCBC.ENCRYPTION_KEY_SIZE, StorageTask$$Lambda$6.lambdaFactory$(this));
    @VisibleForTesting
    ...
    static {
        ...
        Integer valueOf = Integer.valueOf(CipherStorageKeystoreAESCBC.ENCRYPTION_KEY_SIZE);
        hashMap.put(1, new HashSet(Arrays.asList(new Integer[]{16, valueOf})));
        ...
        ValidUserInitiatedStateChanges.put(16, new HashSet(Arrays.asList(new Integer[]{2, valueOf})));
        ValidUserInitiatedStateChanges.put(64, new HashSet(Arrays.asList(new Integer[]{2, valueOf})));
        ...
        ValidTaskInitiatedStateChanges.put(32, new HashSet(Arrays.asList(new Integer[]{valueOf, 64, 128})));
    }
    ...
    public boolean cancel() {
        return tryChangeState(new int[]{CipherStorageKeystoreAESCBC.ENCRYPTION_KEY_SIZE, 32}, true);
    }
    ...
    private void ensureFinalState() {
        if (!isComplete() && !isPaused() && getInternalState() != 2 && !tryChangeState((int) CipherStorageKeystoreAESCBC.ENCRYPTION_KEY_SIZE, false)) {
