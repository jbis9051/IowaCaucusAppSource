...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public boolean excludeField(Field field, boolean z) {
        ...
        if ((this.version != IGNORE_VERSIONS && !isValidVersion(field.getAnnotation(Since.class), field.getAnnotation(Until.class))) || field.isSynthetic()) {
            return true;
        }
        if (this.requireExpose && ((annotation = field.getAnnotation(Expose.class)) == null || (!z ? !annotation.deserialize() : !annotation.serialize()))) {
            return true;
        }
    ...
    public boolean excludeClass(Class<?> cls, boolean z) {
        if (this.version != IGNORE_VERSIONS && !isValidVersion(cls.getAnnotation(Since.class), cls.getAnnotation(Until.class))) {
            return true;
        }
