...
public class SvgView extends ReactViewGroup implements ReactCompoundView, ReactCompoundViewGroup {
    ...
    public void setId(int i) {
        SvgView.super.setId(i);
        SvgViewManager.setSvgView(i, this);
    }

    public void invalidate() {
        SvgView.super.invalidate();
        VirtualView parent = getParent();
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        SvgView.super.onSizeChanged(i, i2, i3, i4);
        invalidate();
    }
    ...
    public synchronized void drawChildren(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            VirtualView childAt2 = getChildAt(i2);
            if (childAt2 instanceof VirtualView) {
                VirtualView virtualView = childAt2;
    ...
    private int hitTest(float f, float f2) {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            VirtualView childAt = getChildAt(childCount);
            if (childAt instanceof VirtualView) {
                i = childAt.hitTest(fArr);
