...
public final class Spdy3 implements Variant {
    ...
    static final class Reader implements FrameReader {
        ...
        public boolean nextFrame(FrameReader.Handler handler) throws IOException {
            ...
            try {
                ...
                if ((Integer.MIN_VALUE & readInt) != 0) {
                    ...
                    int i4 = readInt & OkHttpChannelBuilder.DEFAULT_FLOW_CONTROL_WINDOW;
                    if (i3 == 3) {
                        switch (i4) {
                            case 1:
                    ...
                    int i5 = readInt & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO;
                    if ((i & 1) != 0) {
                        z = true;
                    }
        ...
        private void readSynStream(FrameReader.Handler handler, int i, int i2) throws IOException {
            int readInt = this.source.readInt();
            int readInt2 = this.source.readInt();
            int i3 = readInt & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO;
            int i4 = readInt2 & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO;
            this.source.readShort();
            List<Header> readNameValueBlock = this.headerBlockReader.readNameValueBlock(i2 - 10);
            handler.headers((i & 2) != 0, (i & 1) != 0, i3, i4, readNameValueBlock, HeadersMode.SPDY_SYN_STREAM);
        }

        private void readSynReply(FrameReader.Handler handler, int i, int i2) throws IOException {
            handler.headers(false, (i & 1) != 0, this.source.readInt() & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, -1, this.headerBlockReader.readNameValueBlock(i2 - 4), HeadersMode.SPDY_REPLY);
        }
        ...
        private void readHeaders(FrameReader.Handler handler, int i, int i2) throws IOException {
            handler.headers(false, false, this.source.readInt() & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO, -1, this.headerBlockReader.readNameValueBlock(i2 - 4), HeadersMode.SPDY_HEADERS);
        }
        ...
        private void readWindowUpdate(FrameReader.Handler handler, int i, int i2) throws IOException {
            if (i2 == 8) {
                ...
                int readInt2 = this.source.readInt();
                int i3 = readInt & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO;
                long j = (long) (readInt2 & RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO);
                if (j != 0) {
