...
public abstract class ParserMinimalBase extends JsonParser {
    ...
    protected static final BigInteger BI_MAX_LONG = BigInteger.valueOf(Clock.MAX_TIME);
    ...
    public void reportOverflowLong() throws IOException {
        _reportError(String.format("Numeric value (%s) out of range of long (%d - %s)", new Object[]{_longIntegerDesc(getText()), Long.MIN_VALUE, Long.valueOf(Clock.MAX_TIME)}));
    }
