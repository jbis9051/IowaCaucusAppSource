    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 5:
                ...
                this.name_ = mergeFromVisitor.visitString(!this.name_.isEmpty(), this.name_, !logDescriptor.name_.isEmpty(), logDescriptor.name_);
                this.labels_ = mergeFromVisitor.visitList(this.labels_, logDescriptor.labels_);
                this.description_ = mergeFromVisitor.visitString(!this.description_.isEmpty(), this.description_, !logDescriptor.description_.isEmpty(), logDescriptor.description_);
                this.displayName_ = mergeFromVisitor.visitString(!this.displayName_.isEmpty(), this.displayName_, true ^ logDescriptor.displayName_.isEmpty(), logDescriptor.displayName_);
