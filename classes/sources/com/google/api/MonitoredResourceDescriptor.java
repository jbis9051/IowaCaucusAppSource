    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 5:
                ...
                this.name_ = mergeFromVisitor.visitString(!this.name_.isEmpty(), this.name_, !monitoredResourceDescriptor.name_.isEmpty(), monitoredResourceDescriptor.name_);
                this.type_ = mergeFromVisitor.visitString(!this.type_.isEmpty(), this.type_, !monitoredResourceDescriptor.type_.isEmpty(), monitoredResourceDescriptor.type_);
                this.displayName_ = mergeFromVisitor.visitString(!this.displayName_.isEmpty(), this.displayName_, !monitoredResourceDescriptor.displayName_.isEmpty(), monitoredResourceDescriptor.displayName_);
                this.description_ = mergeFromVisitor.visitString(!this.description_.isEmpty(), this.description_, true ^ monitoredResourceDescriptor.description_.isEmpty(), monitoredResourceDescriptor.description_);
                this.labels_ = mergeFromVisitor.visitList(this.labels_, monitoredResourceDescriptor.labels_);
