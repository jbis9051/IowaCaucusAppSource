...
final class zzx extends zzjm {
    ...
    public final boolean zza(zzjy zzjy) {
        ...
        contentValues.put(AppMeasurementSdk.ConditionalUserProperty.ORIGIN, zzjy.zzb);
        ...
        zza(contentValues, AppMeasurementSdk.ConditionalUserProperty.VALUE, zzjy.zze);
        try {
    ...
    public final boolean zza(zzq zzq) {
        ...
        contentValues.put(AppMeasurementSdk.ConditionalUserProperty.ORIGIN, zzq.zzb);
        contentValues.put(AppMeasurementSdk.ConditionalUserProperty.NAME, zzq.zzc.zza);
        zza(contentValues, AppMeasurementSdk.ConditionalUserProperty.VALUE, zzq.zzc.zza());
