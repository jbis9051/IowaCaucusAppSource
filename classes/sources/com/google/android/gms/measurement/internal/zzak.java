...
public final class zzak {
    static zzr zza;
    public static zzdy<Long> zzaa = zza("measurement.alarm_manager.minimum_interval", 60000L, 60000L, zzbf.zza);
    ...
    public static zzdy<Integer> zzai = zza("measurement.audience.filter_result_max_count", 200, 200, zzbm.zza);
    ...
    static {
        ...
        zzq = zza("measurement.upload.max_conversions_per_day", valueOf, valueOf, zzas.zza);
        Double valueOf2 = Double.valueOf(-3.0d);
        zzao = zza("measurement.test.double_flag", valueOf2, valueOf2, zzbs.zza);
    }
}
