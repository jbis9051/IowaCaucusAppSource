...
public final class zzgt extends zzg {
    ...
    private final void zzb(Bundle bundle, long j) {
        ...
        zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.ORIGIN, String.class, null);
        zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.NAME, String.class, null);
        zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.VALUE, Object.class, null);
    ...
    public final void zzd(Bundle bundle) {
        ...
        try {
            zzai zza2 = zzp().zza(bundle2.getString("app_id"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME), bundle2.getBundle(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN), bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.CREATION_TIMESTAMP), true, false);
            zzjw zzjw2 = zzjw;
            zzh().zza(new zzq(bundle2.getString("app_id"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN), zzjw2, bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.CREATION_TIMESTAMP), bundle2.getBoolean("active"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME), (zzai) null, bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT), (zzai) null, bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.TIME_TO_LIVE), zza2));
        } catch (IllegalArgumentException unused) {
        }
    }
