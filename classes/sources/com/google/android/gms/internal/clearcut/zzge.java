...
public final class zzge {
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            DOCS_OFFLINE(306),
            FREIGHTER(307),
            DOCS_IOS_PRIMES(HttpUrlConnectionNetworkFetcher.HTTP_PERMANENT_REDIRECT),
            ...
            ANDROID_GROWTH(498),
            GHS_CLIENT_LOGS(499),
            GOR_ANDROID_PRIMES(JsonLocation.MAX_CONTENT_SNIPPET),
            NETREC(501),
            NETREC_COUNTERS(502),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case 307:
                        return FREIGHTER;
                    case HttpUrlConnectionNetworkFetcher.HTTP_PERMANENT_REDIRECT:
                    ...
                    case JsonLocation.MAX_CONTENT_SNIPPET:
